...
Based on data up to and including 2019, births in the _Star Wars_ multiverse can be said to happen every `{r} round(avg_years_between_births, 1)` years on average.
